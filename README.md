...
> **Personal note:** I mostly use `/geo audit` and `/geo citability` — those two cover 90% of what I need day-to-day. The `quick` command is handy for a fast sanity check before publishing a new post.
